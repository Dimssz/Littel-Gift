...
function submitPassword() {
    if (password === "1101") { 
      ...
      if(error == 2){
        document.getElementById("salah").innerHTML = "hayoo apaa";
      }
      if(error == 3){
        document.getElementById("salah").innerHTML = "masih salah";
      }
      if(error == 4){
        document.getElementById("salah").innerHTML = "itu loohhh";
      }
      if(error >= 5){
        document.getElementById("salah").innerHTML = "yaah masa engga tau";
      }
